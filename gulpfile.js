...
gulp.task('watch', ['build'], function () {
    gulp.watch(['./app/*.jsx','./app/**/*.jsx','!./app/babylon.min.js'], ['build']);
});
...
gulp.task('js:copy', function() {
  return gulp.src('app/babylon.min.js')
    .pipe(gulp.dest('dist'));
})
...
gulp.task('default', ['serve','js:copy','build:html','watch']);
